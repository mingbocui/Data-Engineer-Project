...
#
# Define a function for the PythonOperator to call and have it log something
#
def hello_world():
...
#
# Uncomment the operator below and replace the arguments labeled <REPLACE> below
#
